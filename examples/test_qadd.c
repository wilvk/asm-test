...
TEST(codec, saturating_add_known_edges) {
    ...
    vec128_t a = {.u64 = {0, 0}};
    vec128_t b = {.u64 = {0, 0}};
    a.u8[0] = 200; b.u8[0] = 100; /* 300 -> clamps to 255 */
    a.u8[1] = 10;  b.u8[1] = 20;  /* 30  -> exact          */
    a.u8[2] = 255; b.u8[2] = 255; /* 510 -> clamps to 255  */
    a.u8[3] = 255; b.u8[3] = 0;   /* 255 -> the boundary    */
...
TEST(codec, saturating_add_matches_model) {
    ...
    for (int t = 0; t < 5000; t++) {
        vec128_t a = {.u64 = {0, 0}}, b = {.u64 = {0, 0}}, want = {.u64 = {0, 0}};
        for (int i = 0; i < 16; i++) {
            ...
            want.u8[i] = s > 0xFF ? 0xFF : (unsigned char)s; /* C model: clamp */
        }
        regs_t r;
        ASM_VCALL2(&r, qadd_u8x16, a, b);
        ASSERT_VEC_EQ(&r, 0, want.u8); /* all 16 lanes, saturation edge included */
    }
}
