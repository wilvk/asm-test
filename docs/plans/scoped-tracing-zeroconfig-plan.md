...
PT runner exists — the gate [hardware-trace-plan.md](hardware-trace-plan.md) already accepts.
...
- Extend [docs/guides/tracing/hardware-tracing.md](../guides/tracing/hardware-tracing.md) with
  ...
  [docs/analysis/trace-parity-matrix.md](../analysis/trace-parity-matrix.md) with the
...
- **The synthetic PT fixture cannot substitute for silicon.** It exercises the decode *logic*
  ...
  [hardware-trace-plan.md](hardware-trace-plan.md) accepts. Passing §Z2 is necessary, not
