...
| [amd-branchsnap-lbr-docs.md](amd-branchsnap-lbr-docs.md) — branchsnap depth fix, LBR tiling validation, freeze-probe cleanup, Zen 3 BRS story | 8 | ◐ 3/8 (T2/T3 live legs gated: Zen 5 BPF; T4 wip) | — (soft: shares the Zen 3 story with the sibling above) |
