...
| Document | Tasks | Status | Depends on |
|---|---|---|---|
| [inproc-btf-block-step.md](inproc-btf-block-step.md) — W3: in-process BTF branch-granular single-step | 6 | ◐ 4/6 (T1-T4 done; T4's teeth check confirmed — disabling the reversal makes the order assertions fail) | — |
