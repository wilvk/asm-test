...
| [dataflow-f4-object-identity.md](dataflow-f4-object-identity.md) — real object identity via GCBulkType/Node/Edge | 6 | ◐ 0/6 (T1 wip) | — |
...
| Document | Tasks | Status | Depends on |
|---|---|---|---|
| [intel-pt-whole-window-substrate.md](intel-pt-whole-window-substrate.md) — PT whole-window capture substrate, STRONG ladder, inline ctor | 5 | ◐ 1/5 (T2 wip) | — |
...
| Document | Tasks | Status | Depends on |
|---|---|---|---|
| [asmspy-cli-enhancements.md](asmspy-cli-enhancements.md) — TUI hot-edge drill-in, syscall-arg content decode, coverage gaps | 9 | ◐ 0/9 (T1 wip) | — |
...
| [riscv-native-tier.md](riscv-native-tier.md) — native RISC-V (rv64) host tier | 7 | ◐ 0/7 (T1 wip) | — |

### CI, distribution & infrastructure
| Document | Tasks | Status | Depends on |
|---|---|---|---|
| [distribution-packaging.md](distribution-packaging.md) — language-registry go-live + system package-manager coverage | 13 | ◐ 1/13 (T7 landed: `make package-source` reproducible tarball + `SHA256SUMS`, wired into release.yml corresponding-source job, verified locally — extract→`make lib`→`make install`→pkg-config consumer green) | — |
