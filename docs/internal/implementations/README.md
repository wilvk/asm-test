...
| Document | Tasks | Status | Depends on |
|---|---|---|---|
| [pin-sde-future-isa-lane.md](pin-sde-future-isa-lane.md) — SDE future/absent-ISA test lane | 8 | ◐ 0/8 (picked up — implementing agent in progress) | — |
...
| [pin-libdft-taint-oracle.md](pin-libdft-taint-oracle.md) — libdft64 differential oracle for the DR taint tier | 7 | ◐ 0/7 (picked up — implementing agent in progress) | **pin-xed-trace-tier** |
...
| [native-il-bytecode-attribution.md](native-il-bytecode-attribution.md) — native trace-point → IL/bytecode/source-line attribution | 7 | ◐ 0/7 (picked up — implementing agent in progress) | — |
