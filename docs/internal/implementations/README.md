...
| [macos-oop-mach-stepper.md](macos-oop-mach-stepper.md) — macOS out-of-process single-step via Mach exception ports | 7 | ◐ 6/7 (`make mach-stepper-test` green on this host: 25/25 live, signed + unsigned EPERM self-skip + Linux host-guard skip all verified) | — |
