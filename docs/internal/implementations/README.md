...
| [dataflow-pt-replay-tier.md](dataflow-pt-replay-tier.md) — F5: PT + code-image + Unicorn-replay value tier | 5 | ◐ 0/5 (batch wip: T1/T2/T3/T5 via synthetic fixture + T4 behind PT-silicon/sibling gate) | **intel-pt-attach-foreign-pid** |
