...
| [dataflow-f4-object-identity.md](dataflow-f4-object-identity.md) — real object identity via GCBulkType/Node/Edge | 6 | ◐ 1/6 (T1 landed: `asmtest_objid_*` pure transform + `test_dataflow_objid` 27/27; T2 next) | — |
