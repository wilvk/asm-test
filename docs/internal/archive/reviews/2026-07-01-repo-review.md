...
overlapping files, and `docs/internal/analysis/trace-parity-matrix.md` restates tables
that also live in `docs/features.md` and the plans. Much of `docs/internal/plans/` and
`docs/internal/analysis/` reads like design scratchpad kept in-tree rather than pruned
after landing.
