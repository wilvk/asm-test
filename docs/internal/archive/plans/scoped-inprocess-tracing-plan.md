...
6. The **libipt decode-against-self-code-image glue** plus **whole-window
   ...
   [hardware-trace-plan Phase 2](../../plans/hardware-trace-plan.md#phase-2---attach-to-foreign-jit-tracing-byte-source-recorder-done-pt-attach-decode-forward-look).
...
This umbrella splits that into three focused slice plans plus a **capstone**
slice, dependency-ordered:
...
- **Availability is a host property, not code** (repeated from the hardware-trace
  ...
  [hardware-trace-plan CI](../../plans/hardware-trace-plan.md#phase-1---hardware-assisted-trace-backends-intel-pt-arm-coresight-planned)).
...
- **The libipt decode-against-self-code-image glue needs PT hardware to validate**,
  exactly like [hardware-trace-plan Phase 2](../../plans/hardware-trace-plan.md). It ships as
...
- **The whole-window PT experience is the least-complete, least-tested part of the
  ...
  forward-look, exactly as [hardware-trace-plan.md](../../plans/hardware-trace-plan.md) already
...
- **[hardware-trace-plan.md](../../plans/hardware-trace-plan.md)** — supplies the PT/CoreSight
