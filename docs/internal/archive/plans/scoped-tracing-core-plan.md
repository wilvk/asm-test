...
slice](../../plans/scoped-tracing-managed-plan.md)) stays thin and mechanical.
...
cross-link [hardware-trace-plan Phase 2](../../plans/hardware-trace-plan.md) as the shared
build; update [docs/internal/analysis/trace-parity-matrix.md](../../analysis/trace-parity-matrix.md)
...
- **§2's live half needs PT hardware** (this dev host is AMD — no PT, ever). It
  ...
  CI-validated, exactly as [hardware-trace-plan](../../plans/hardware-trace-plan.md) accepts
