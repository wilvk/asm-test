...
3. Update [docs/reference/ci.md](../../../reference/ci.md)'s job list
...
2. [docs/index.md](../../../index.md) line 69 same fix.
3. [docs/reference/portability.md](../../../reference/portability.md):
...
4. [docs/guides/abi-capture.md](../../../guides/abi-capture.md): document
   ...
   T2.
5. [docs/reference/ci.md](../../../reference/ci.md): the `test-riscv64`
...
- **Self-hosted RISC-V CI hardware** — if real rv64 boards ever join CI,
  that's [self-hosted-ci-runners.md](../../implementations/self-hosted-ci-runners.md) territory.
