...
> [dynamorio-native-trace-plan.md](../plans/dynamorio-native-trace-plan.md)
...
3. An arm64 (`macos-latest`) leg is deferred: it needs T8 plus an arm64 DR
   ...
   follow-up belongs to [self-hosted-ci-runners.md](../../implementations/self-hosted-ci-runners.md).
...
- **Docker-OSX / KVM macOS cleanroom lanes and any containerized-macOS
  validation** — [macos-cleanroom-lanes.md](../../implementations/macos-cleanroom-lanes.md) (note
...
- **A self-hosted arm64 macOS runner with a real signing identity** for a
  future arm64 CI leg — [self-hosted-ci-runners.md](../../implementations/self-hosted-ci-runners.md).
...
- **Shipping/packaging the macOS artifacts** (wheels/gems bundling a DR
  payload) — [distribution-packaging.md](../../implementations/distribution-packaging.md).
