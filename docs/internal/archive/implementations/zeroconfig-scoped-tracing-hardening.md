...
> [call-descent-plan.md](../plans/call-descent-plan.md) (the §L3
...
3. Keep any AMD statement in the new text at the **Zen 4+** floor; do not touch
   ...
   [amd-branchsnap-lbr-docs.md](../../implementations/amd-branchsnap-lbr-docs.md).
...
1. In `troubleshooting.md`, extend the `## Hardware-trace tiers` section
   ...
   - **The skip-reason table.** The reason strings are static literals produced
     ...
     [amd-branchsnap-lbr-docs.md](../../implementations/amd-branchsnap-lbr-docs.md). Mention the .NET
...
- **AMD LBR documentation truth-up** (the Zen 4+ floor corrections across
  ...
  arm) — [amd-branchsnap-lbr-docs.md](../../implementations/amd-branchsnap-lbr-docs.md); IBS window-lane
