...
2. Rewrite those three places (edits below). Leave the rest of the doc (the
   ...
   [amd-branchsnap-lbr-docs.md](../../implementations/amd-branchsnap-lbr-docs.md) (the global "Zen 4+
...
- **branchsnap depth-check fix (P2), Zen 3 BRS documentation truth (P4), the
  ...
  floor correction** — [amd-branchsnap-lbr-docs.md](../../implementations/amd-branchsnap-lbr-docs.md).
- **The self-hosted Zen runner (P9)** —
  [self-hosted-ci-runners.md](../../implementations/self-hosted-ci-runners.md). T2's checklist stays
