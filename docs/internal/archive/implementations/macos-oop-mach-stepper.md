...
**Steps.**
1. Extend [docs/guides/tracing/native-tracing.md](../../../guides/tracing/native-tracing.md)'s
...
2. Add a one-line row/note to [docs/reference/portability.md](../../../reference/portability.md)'s
...
- The macOS clean-room dlopen lanes (Tracks A–E of the clean-test plan) — a different code path,
  owned by [macos-cleanroom-lanes.md](../../implementations/macos-cleanroom-lanes.md).
