...
[self-hosted-ci-runners.md](../../implementations/self-hosted-ci-runners.md)'s scope; this task
...
- **ARM CoreSight live decode** (the other hardware backend):
  [coresight-live-decode.md](../../implementations/coresight-live-decode.md).
- **Provisioning/gating the bare-metal Intel runner:**
  [self-hosted-ci-runners.md](../../implementations/self-hosted-ci-runners.md).
- **AMD LBR documentation/floor corrections (Zen 4+) and the silicon-gated
  capture arm:** [amd-branchsnap-lbr-docs.md](../../implementations/amd-branchsnap-lbr-docs.md).
