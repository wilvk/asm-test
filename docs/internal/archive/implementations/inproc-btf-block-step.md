...
3. [docs/internal/archive/plans/zen2-singlestep-trace-plan.md](../plans/zen2-singlestep-trace-plan.md):
...
- AMD LBR capture/docs work, the Zen 4+ floor correction, and the
  ...
  [amd-branchsnap-lbr-docs.md](../../implementations/amd-branchsnap-lbr-docs.md); IBS backend
