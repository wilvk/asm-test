...
emits it ([asmtrace-schema.md:320](../../gui/asmtrace-schema.md#L320)). Three deferred
...
- **The reserved kind + its consumer.** `mem` row at
  [asmtrace-schema.md:320](../../gui/asmtrace-schema.md#L320); the 3D consumer's gate,
...
**Steps.**
1. Define the fields in [asmtrace-schema.md](../../gui/asmtrace-schema.md) (append under the
