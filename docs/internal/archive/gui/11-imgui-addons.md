...
> addon-admission rule ([README.md](../../gui/README.md), "D2 — pinned deps"). The two
...
>
> **Superseded by completion (2026-08-01).** The "no addon code is written yet"
> note above is stale: **every track this document plans has since shipped.**
> Docs 12–17 are all complete — 12 addon-supply-chain ☑ 3/3 (Track G), 13
> foundation-moves ☑ 5/5 (Track F: docking repin, 32-bit `ImDrawIdx`, freetype +
> JetBrains Mono + Codicons, the 1.92 decision), 14 quick-wins ☑ 7/7 (Track Q),
> 15 plotting-and-graph-nav ✅ 3/3 (ImPlot, imgui_canvas, node-editor), 16
> live-feedback-and-filtering ✅ 2/2 (ImGuiNotify, ImSearch), 17
> interaction-testing-and-editor ✅ 2/2 (imgui_test_engine, ImGuiColorTextEdit +
> TextDiff — the two "bigger bets"). This document is retained as the **research
> record**: the survey, the license/maintenance findings, and the recorded
> negative results (notably that no ImGui/AccessKit accessibility binding
> exists) are what outlive the adoption itself.
>
...
> see [README.md](../../gui/README.md) ("D2 — pinned deps", Amended clause). Track G is
