...
> are the [freeze checklist](../../gui/asmtrace-schema.md#known-v1-gaps--the-freeze-checklist)
...
- **The freeze checklist** names all three with the fix pre-sketched
  ([asmtrace-schema.md:400-418](../../gui/asmtrace-schema.md#L400)): "A `code` header object
...
2. Freeze decision to record in [asmtrace-schema.md](../../gui/asmtrace-schema.md): the
...
- Directly closes three [freeze-checklist](../../gui/asmtrace-schema.md#known-v1-gaps--the-freeze-checklist)
