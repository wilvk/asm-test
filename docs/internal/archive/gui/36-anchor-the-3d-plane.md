...
([asmtrace-schema.md](../../gui/asmtrace-schema.md) *"No block starts from the L0
...
8. Docs: `CHANGELOG.md` (`Fixed`); [10](10-spacetime-3d-overview.md) T3 and
   ...
   **doc-only** clarification to [asmtrace-schema.md](../../gui/asmtrace-schema.md) stating
...
[01](01-asmtrace-format.md) + [asmtrace-schema.md](../../gui/asmtrace-schema.md) (doc-only
