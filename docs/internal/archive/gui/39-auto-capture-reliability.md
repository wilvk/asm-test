...
> **A per-gap brief cut from [38](../../gui/38-live-feed-completion-roadmap.md)**, and the
...
> [README.md](../../gui/README.md)'s row for the commit-by-commit summary); this banner
...
2. Fix two stale references in [38](../../gui/38-live-feed-completion-roadmap.md): its text
   ([38:93](../../gui/38-live-feed-completion-roadmap.md)) says *"the closable remainder is
   ...
   ([38:64](../../gui/38-live-feed-completion-roadmap.md)) links `amd-live-validation` to
...
- **aarch64 gets neither sampler.** Both live in the same
  ...
  [38](../../gui/38-live-feed-completion-roadmap.md) L1), but no change here may deepen the
...
- **Not per-tid attribution.** [38](../../gui/38-live-feed-completion-roadmap.md) records that
...
Cut from [38](../../gui/38-live-feed-completion-roadmap.md) (live-feed roadmap). The one-shot
