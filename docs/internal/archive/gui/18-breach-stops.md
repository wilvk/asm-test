...
> ([../archive/plans/desktop-gui-ux-restructure-plan.md](../plans/desktop-gui-ux-restructure-plan.md))
> rows **T1.1** (remainder), **T2.2**, **T2.6**, **T4.2**, **T4.5**, **T3.2** —
> the plan's **Wave 0** — and the review findings **F1, F18, F2, F24, F19, F22,
> F11** ([../archive/reviews/desktop-gui-ux-review.md](../reviews/desktop-gui-ux-review.md)).
...
> this directory's [README](../../gui/README.md). **Prerequisites:
