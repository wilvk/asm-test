...
- **Graded-fidelity `severity` schema field** ([23](23-graded-truth-layer.md) T1,
  ...
  01-owner sign-off ([asmtrace-schema.md](../../gui/asmtrace-schema.md) owner sign-off note).
...
1. **R1 first.** Cheapest (S–M), no new engine, and it is a prerequisite for R4
   ...
   [freeze checklist](../../gui/asmtrace-schema.md#known-v1-gaps--the-freeze-checklist)."
...
| `zstd-frames` container reading | [asmtrace-schema.md](../../gui/asmtrace-schema.md) (reserved, refused by name) | PT-scale container format (Phase 3, D1) |
