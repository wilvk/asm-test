...
- **The compatibility rule, already written.** *"Ignore unknown fields. Additive
  ...
  ([asmtrace-schema.md:558](../../gui/asmtrace-schema.md)), with the worked precedent in
...
- **The freeze status.** [asmtrace-schema.md](../../gui/asmtrace-schema.md) still reads
...
fallback). Schema/D5 [01](01-asmtrace-format.md) + [asmtrace-schema.md](../../gui/asmtrace-schema.md),
