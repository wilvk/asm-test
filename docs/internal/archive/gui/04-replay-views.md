...
>    ([asmtrace-schema.md](../../gui/asmtrace-schema.md)).
...
>
> Set decisions D1–D11 in [README.md](../../gui/README.md) bind this doc. Siblings consumed:
...
([asmtrace-schema.md](../../gui/asmtrace-schema.md)). What this doc needed on top of
...
[asmtrace-schema.md](../../gui/asmtrace-schema.md)'s corpus section (owned by 01 — append only).
