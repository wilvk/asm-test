...
> **A per-gap brief cut from [38](../../gui/38-live-feed-completion-roadmap.md)** (gap **L2**,
...
> ([asmtrace-schema.md](../../gui/asmtrace-schema.md)), exactly what the segmenter needs, and
...
Flip [38](../../gui/38-live-feed-completion-roadmap.md)'s L2 row to **CLOSED (doc 40)** with a
one-line reality note (mirror the Scrubber; latest is the live default; segmented
model exposed), add the doc-40 row to [README.md](../../gui/README.md)'s follow-on list, and
...
- **Not** a per-pass *diff* or cross-pass convergence — `df_step` carries no `tid`,
  ...
  ([38](../../gui/38-live-feed-completion-roadmap.md)'s corrected not-a-gap). Passes are
