...
1. **Decision D2 forbids it.** D2 ([README](README.md) and
...
> directory's [README.md](README.md) with exactly the five-point admission rule
...
**Steps.**
1. Edit **D2 in this directory's [README.md](README.md)** (the "Binding shared
