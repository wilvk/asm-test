...
> **Sources.** Phase A of [43-faithful-city-roadmap.md](43-faithful-city-roadmap.md),
...
> directory's [README](README.md). **Prerequisites: none** — every task here reads
...
[Phase D](43-faithful-city-roadmap.md)) so the plane gains legible zoning by
...
- **The shader baseline.** `kTerrainVert`/`kTerrainFrag`
  ...
  [Phase D](43-faithful-city-roadmap.md)).
...
- **The LOD/degrade precedent.** `should_degrade` (`ui/progress.h:80`, used at
  ...
  ([43](43-faithful-city-roadmap.md) Phase C); Phase A does not need it (its
...
[43](43-faithful-city-roadmap.md) Phase E's gap) renders EXACTLY today's amber
...
space per [43](43-faithful-city-roadmap.md)'s Phase B note that arcs/roads etc.
...
- **No `space/city.{h,cpp}` `CityModel`, no buildings, no instancing.** That is
  [Phase D](43-faithful-city-roadmap.md) — this brief only reskins the existing
...
- **No roads, no errands, no district-commute crossings, no rendezvous
  pick-ability.** [Phase B](43-faithful-city-roadmap.md).
- **No LOD/entity-budget system.** [Phase C](43-faithful-city-roadmap.md); T1's
...
[43-faithful-city-roadmap.md](43-faithful-city-roadmap.md) (the family this cuts
