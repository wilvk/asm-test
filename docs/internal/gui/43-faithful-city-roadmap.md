...
> schedules. This doc does for them what [27](27-extension-roadmap.md) did for
...
> brief ([44](44-faithful-city-phase-a-mvp-terrain-reskin.md)). Read
...
> same change.
>
> **Status — roadmap only, no tasks of its own.** Phase A is cut as [44](44-faithful-city-phase-a-mvp-terrain-reskin.md),
> ☐ 0/7. Phases B–E are NOT yet cut into implementation-ready briefs (see §4).
...
- **Cut phases one at a time, like [39](39-auto-capture-reliability.md)/[40](40-segment-dataflow-by-invocation.md)/[41](41-live-blame-statediff-serve-leg.md)
...
([10-spacetime-3d-overview.md](10-spacetime-3d-overview.md),
[34-playhead-and-scene-reach.md](34-playhead-and-scene-reach.md) — the two-clock
/ execution-step-brush precedent Phase A's vehicle reuses) and absorbs
[36](36-anchor-the-3d-plane.md)/[37](37-region-tag-on-df-step.md)'s placement work
unchanged (the city's Plat sits on the SAME projection/terrain those docs already
place onto). Fidelity chrome D7 / [23](23-graded-truth-layer.md); wording D7 /
[24](24-one-visual-language.md). The live-feed roadmap
