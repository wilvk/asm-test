...
static int usage(const char *argv0) {
    fprintf(
        ...
        "[--steps] "
        "[--mem] [--blame] [--statediff] [--insns] [--fpregs] [--continuous]  "
        "scoped "
        "L0 "
        ...
        "effective address stream the 3D rich rung reads). --insns adds the "
        "ordered `trace` instruction stream over the same steps — what lets "
        "two dataflow recordings be ALIGNED for the desktop's divergence "
        "scene. --fpregs adds the "
